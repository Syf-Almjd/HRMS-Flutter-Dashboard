...
abstract class AppColors {
  static const Color primaryColor = Color(0xff5963dc); //0xff4e4edd
  static const Color lowPriority = Color(0xff8c70ff);

  static const Color secondaryColor = Color(0xFF1e224c);
  ...
  static const Color bgColor = Color(0xFF545D81);
}
